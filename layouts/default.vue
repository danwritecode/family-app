          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              <div class="flex-shrink-0 flex items-center">
                ...
                <h1 class="font-black text-lg">NelsonFamilyApp</h1>
              </div>
            ...
            <div class="hidden sm:ml-6 sm:flex sm:items-center">
              ...
              <div class="ml-3 relative">
                ...
                -->
                <div v-if="showProfileDropdown" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white border border-gray-300" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
